...
struct XREContext * context_alloc(char const * key, Component component) {
...
inline struct XREContext * context_root_alloc(void) {
    return context_alloc(NULL, NULL);
};


void context_destroy(struct XREContext * context) {
